...
class Arguments:
    def __init__(self):
        ...
        # Dataset argument
        self._parser.add_argument('--dataset_path', type=str, default='./drive/MyDrive/shapenetcore_partanno_segmentation_benchmark_v0', help='Dataset file path.')
        ...
        self._parser.add_argument('--ckpt_path', type=str, default='./drive/MyDrive/tcc/resultados/', help='Checkpoint path.')
