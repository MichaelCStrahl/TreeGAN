...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--epochs', type=int, default=21, help='Integer value for epochs.')
        self._parser.add_argument('--lr', type=float, default=1e-4, help='Float value for learning rate.')
        self._parser.add_argument('--ckpt_path', type=str, default='/content/drive/MyDrive/Resultados - Lothar', help='Checkpoint path.')
        self._parser.add_argument('--ckpt_save', type=str, default='tree_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str,"""default='tree_ckpt_pretrained.pt'""", help='Checkpoint name to load.')
